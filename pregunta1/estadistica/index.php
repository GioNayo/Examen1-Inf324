          ...
          <div class="col-xs-12">
            <div class="cd-slider-nav">
              <nav class="navbar navbar-expand-lg" id="tm-nav">
                <a class="navbar-brand" href="../index.php">FACULTAD DE CIENCIAS <br> PURAS Y NATURALES</a>
                  ...
                  <div class="collapse navbar-collapse" id="navbar-supported-content">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#0" data-no="3">CONTACTOS</a>
                        <div class="circle"></div>
                      </li>
            ...
            <div class="page-width-1 page-left">
              <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                <div class="intro-left tm-bg-dark">
                  <h2 class="mb-4">Bienvenido a la carrera de Estadistica</h2>
                  <p class="mb-4">
                ...
                <div class="intro-right">
                  <img src="../img/estadistica.jpg" alt="Image" class="img-fluid intro-img-1">
            ...
            <div class="mx-auto position-relative gallery-container">
              ...
              <div class="mx-auto tm-border-top gallery-slider">
                <figure class="effect-julia item">
                    <img src="../img/mate.png" alt="Image">
                    <figcaption>
                        <div>
                            <p>CARRRERA DE MATEMATICA</p>
                        </div>
                        <a href="../mate/index.php">Ver mas</a>
                    </figcaption>
                </figure>
                <figure class="effect-julia item">
                    <img src="../img/info.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>CARRERA DE INFORMATICA</p>
                        </div>
                        <a href="../info/index.php">Ver mas</a>
                    </figcaption>
                </figure>
                <figure class="effect-julia item">
                    <img src="../img/biologia.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>CARRERA DE BIOLOGIA</p>
                        </div>
                        <a href="../biologia/index.php">Ver mas</a>
                    </figcaption>
                </figure>
              <!--
                  <figure class="effect-julia item">
                    <img src="img/estadistica.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>CARRERA DE ESTADISTICA</p>
                        </div>
                        <a href="#">Ver mas</a>
                    </figcaption>
                </figure>
          ...
          <li data-page-no="3" class="px-3">
            <div class="position-relative page-width-1 page-right tm-border-top tm-border-bottom">
              ...
              <div class="tm-bg-dark content-pad">
                <h2 class="mb-4">PARA MAS INFORMACION</h2>
               
                <p>
                  Dirección: Av. Villazón Nº 1995, Plaza del Bicentenario - Zona Central, La Paz - Bolivia.<BR>
                  Telf.: (591-2) 2441570 / 2440571<BR>
                  Fax: 2441092<BR>
                  Email: decanato@fcpn.edu.bo<br>
                  <a href="https://es-la.facebook.com/fcpn.umsa/">FACEBOOK </a> <BR>
                  <a href="https://www.youtube.com/channel/UCziXp6vAr6dQMfgz_dy_hNA">YOUTUBE</a>
